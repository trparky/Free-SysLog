...
Namespace SupportCode
    ...
    Module SupportCode
        ...
        Public uniqueObjects As (uniqueLogTypes As HashSet(Of String), uniqueProcess As HashSet(Of String), hostNames As HashSet(Of String), ipAddresses As HashSet(Of String))
